...
const DateInput: React.FC<DateInputProps> = ({ value, onChange }) => {
  ...
  return (
    <div className="flex border rounded-lg items-center text-sm px-1">
        ...
        className="p-0 outline-none w-7 border-none text-center bg-inherit"
        placeholder="D"
      />
      ...
      <input
        ...
        className="p-0 outline-none w-6 border-none text-center bg-inherit"
        placeholder="M"
      />    
      <span className="opacity-20 -mx-px">/</span>
      <input
        ...
        className="p-0 outline-none w-12 border-none text-center bg-inherit"
        placeholder="YYYY"
      />
    </div>
  )
