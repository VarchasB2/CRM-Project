/*
  ...
  - Added the required column `lead_owner` to the `Contact` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE "Contact" ADD COLUMN     "date" TIMESTAMP(3) NOT NULL,
